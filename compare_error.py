...
#rep 1 data
data_rep1 = 'all echo drop high error'
_, rep1_exp, rep1_err, _, _ = defineExp(data_rep1, model, k_CV, k_PEM_evaluation)
print('rep1 mean error', np.mean(rep1_err))

#rep 2 data
data_rep2 = 'rep2 all echo drop high error'
_, rep2_exp, rep2_err, _, _ = defineExp(data_rep2, model, k_CV, k_PEM_evaluation)
print('rep2 mean error', np.mean(rep2_err))

#rep 3 data
data_rep3 = 'rep3 all echo drop high error'
